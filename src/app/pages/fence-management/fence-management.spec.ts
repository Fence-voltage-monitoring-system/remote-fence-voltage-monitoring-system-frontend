...
describe('FenceManagement', () => {
  ...
  beforeEach(async () => { await TestBed.configureTestingModule({ imports: [FenceManagement], providers:[provideHttpClient()] }).compileComponents(); fixture = TestBed.createComponent(FenceManagement); fixture.detectChanges(); });
