...
export interface FenceOption { code: string; name: string; province:string; district:string; totalSections: number; totalLengthKm: number; operational: number; averageVoltageKv: number; }
